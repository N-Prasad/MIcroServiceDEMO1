package com.prodata.cart_app.exception;
...
public class CartExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(CartNotFoundException.class) // 404 Not Found
	public final ResponseEntity<ErrorDetails> handleProductNotFoundException(CartNotFoundException ex, WebRequest req) {
